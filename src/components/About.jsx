...
const About = () => {
    return (
        <div className="border-b border-neutral-400 pb-4 pt-12">
            <h2 className="my-2 text-center text-4xl">Acerca de mí</h2>

            <div className="flex flex-wrap items-center lg:p-8">
                ...
                <div className="w-full lg:w-1/2">
                    <div className="flex justify-center text-justify lg:justify-start lg:p-6">
                        <p className="wy-2 whitespace-pre-line py-6 text-xl md:text-2xl">
                            {ABOUT_TEXT}
                        </p>
                    </div>
                </div>
